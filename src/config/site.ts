...
export const footerLinks = {
  ...
  social: [
    { title: "GitHub", href: "https://github.com/iamdevnd" },
    { title: "Bluesky", href: "https://devnd.bsky.social" },
    { title: "Schedule Call", href: "https://app.cal.com/dnpro/" },
  ],
...
export const skills = {
  ...
  frameworks: ["Next.js", "React", "FastAPI", "Django", "TailwindCSS"],
  aiml: ["OpenAI GPT", "LangChain", "Hugging Face", "TensorFlow", "PyTorch"],
  databases: ["PostgreSQL", "Firebase", "MongoDB", "Redis", "Supabase"],
  tools: ["Docker", "Vercel", "AWS", "Git", "VS Code"],
} as const
...
export const blogConfig = {
  ...
  defaultAuthor: {
    name: "ND",
    email: "iamdevnd@gmail.com",
    avatar: "/images/avatar.jpg", // Add your avatar image when you have one
    bio: "Applied AI Engineer specializing in Next.js, Python, and cutting-edge AI solutions.",
    social: {
      github: "https://github.com/iamdevnd",
      bluesky: "https://devnd.bsky.social",
      email: "iamdevnd@gmail.com",
  ...
  defaultReadTime: 5, // minutes
  enableComments: false, // Set to true if you want to add comments later
  enableLikes: true,
  enableViews: true,
  enableSharing: true,
